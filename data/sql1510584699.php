...
CREATE TABLE `noab_ext` (
  ...
  PRIMARY KEY (`id`),
  KEY `module` (`module`)
) ENGINE=MyISAM AUTO_INCREMENT=373 DEFAULT CHARSET=utf8 COMMENT='字段管理器';
...
) ENGINE=MyISAM AUTO_INCREMENT=1647 DEFAULT CHARSET=utf8 COMMENT='内容主表';
...
CREATE TABLE `noab_res` (
  ...
  PRIMARY KEY (`id`),
  KEY `ext` (`ext`)
) ENGINE=MyISAM AUTO_INCREMENT=1201 DEFAULT CHARSET=utf8 COMMENT='资源ID';
