...
<header class="clearfix">
	...
	<div class="right">
		<nav class="top">
			...
			<a href="<?php echo phpok_url(array('ctrl'=>'usercp'));?>">会员中心</a> | 
			<a href="javascript:logout('<?php echo $session['user_name'];?>');void(0);">会员退出</a>
			<?php } else { ?>
			<a href="<?php echo phpok_url(array('ctrl'=>'register'));?>">会员注册</a> | 
			<a href="<?php echo phpok_url(array('ctrl'=>'login'));?>">会员登录</a>
			<?php } ?>
		</nav>
