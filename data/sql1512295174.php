...
) ENGINE=MyISAM AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 COMMENT='分类管理';
...
CREATE TABLE `noab_ext` (
  ...
  PRIMARY KEY (`id`),
  KEY `module` (`module`)
) ENGINE=MyISAM AUTO_INCREMENT=382 DEFAULT CHARSET=utf8 COMMENT='字段管理器';
...
) ENGINE=MyISAM AUTO_INCREMENT=1692 DEFAULT CHARSET=utf8 COMMENT='内容主表';
...
DROP TABLE IF EXISTS noab_list_89;
CREATE TABLE `noab_list_89` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '主题ID',
  `site_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '网站ID',
  `project_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '项目ID',
  `cate_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主分类ID',
...
CREATE TABLE `noab_module` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 COMMENT='模块管理，每创建一个模块自动创建一个表';
...
) ENGINE=MyISAM AUTO_INCREMENT=331 DEFAULT CHARSET=utf8 COMMENT='字段管理器';
...
) ENGINE=MyISAM AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='数据调用中心';
...
CREATE TABLE `noab_project` (
  ...
  KEY `parent_id` (`parent_id`),
  KEY `site_id` (`site_id`,`status`)
) ENGINE=MyISAM AUTO_INCREMENT=224 DEFAULT CHARSET=utf8 COMMENT='项目管理器';
...
CREATE TABLE `noab_res` (
  ...
  PRIMARY KEY (`id`),
  KEY `ext` (`ext`)
) ENGINE=MyISAM AUTO_INCREMENT=1214 DEFAULT CHARSET=utf8 COMMENT='资源ID';
