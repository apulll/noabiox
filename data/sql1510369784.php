...
) ENGINE=MyISAM AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='分类管理';
...
CREATE TABLE `noab_ext` (
  ...
  PRIMARY KEY (`id`),
  KEY `module` (`module`)
) ENGINE=MyISAM AUTO_INCREMENT=350 DEFAULT CHARSET=utf8 COMMENT='字段管理器';
...
) ENGINE=MyISAM AUTO_INCREMENT=1644 DEFAULT CHARSET=utf8 COMMENT='内容主表';
...
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='数据调用中心';
...
CREATE TABLE `noab_res` (
  ...
  PRIMARY KEY (`id`),
  KEY `ext` (`ext`)
) ENGINE=MyISAM AUTO_INCREMENT=1184 DEFAULT CHARSET=utf8 COMMENT='资源ID';
